...
This listener adds OpenTracing instrumentation at [Flogo](https://github.com/project-flogo/) engine level and tracers
...
Instead, it is only required to define an [application-level configuration](#configuration) and to run a
